...
//				case SectionType.TodayQuestion  : this.Section.Text = "LA QUESTION DU JOUR"; break;
				//---------------------------------------------------------------------------------------------------------------
				case SectionType.Divertissement : this.Section.Text = "DIVERTISSEMENT";      break;
				case SectionType.Economy        : this.Section.Text = "ÉCONOMIE";            break;
				case SectionType.HighTech       : this.Section.Text = "HIGH-TECH";           break;
				case SectionType.InfosLive      : this.Section.Text = "LE FIL INFO 24/7";    break;
				case SectionType.International  : this.Section.Text = "INTERNATIONAL";       break;
				case SectionType.Planete        : this.Section.Text = "PLANÈTE";             break;
				case SectionType.Politics       : this.Section.Text = "POLITIQUE";           break;
				case SectionType.Society        : this.Section.Text = "SOCIÉTÉ";             break;
				case SectionType.Sport          : this.Section.Text = "SPORT";               break;
				//---------------------------------------------------------------------------------------------------------------
				}
			//-------------------------------------------------------------------------------------------------------------------
			}
				...
				if ( this.NavigationContext != null && this.NavigationContext.QueryString != null 
					...
					if ( this.NavigationContext.QueryString.ContainsKey ( "Section" ) )
						...
						switch ( this.NavigationContext.QueryString["Section"] )
							...
							case "Divertissement" : CurrentSection = SectionType.Divertissement; break;
							case "Economy"        : CurrentSection = SectionType.Economy;        break;
							case "HighTech"       : CurrentSection = SectionType.HighTech;       break;
							case "InfosLive"      : CurrentSection = SectionType.InfosLive;      break;
							case "International"  : CurrentSection = SectionType.International;  break;
							case "Planete"        : CurrentSection = SectionType.Planete;        break;
							case "Politics"       : CurrentSection = SectionType.Politics;       break;
//							case "TodayQuestion"  : CurrentSection = SectionType.TodayQuestion;  break;
		...
		private void NavigateTo ( bool AllowCache, object Source )
			...
			if ( Source is SectionType )
				...
				if      ( this.CurrentSection == SectionType.Bookmarks )
					...
					{
//					if ( this.CurrentSection == SectionType.TodayQuestion )
//						{
//						string QuestionID = StorageSettings.GetValue ( "question-id", 
//						                                                            string.Empty );
						
//						RestService.GetTodayQuestion ( this.NavigateOnComplete, QuestionID );
//						}
//					else
		...
		private void NavigateOnComplete ( object Sender, RestEventArgs Args )
			...
			if ( ! string.IsNullOrEmpty ( Args.Content ) )
				...
				if ( this.PageNavigator.IsLast ( Source ) )
					...
					if ( Source is Article )
						...
						if ( Args.Result == RestRequestResult.NotFound && 
						                                   ! string.IsNullOrEmpty ( Article.Uri ) )
							{
			...
			//-------------------------------------------------------------------------------------------------------------------
				...
				ApplicationInfos.AsyncGet ( (S, A) =>
					{
					//-----------------------------------------------------------------------------------------------------------
					if ( ! string.IsNullOrEmpty ( A.Ads ) ) Instance.Advertising = A.Ads;

					A.SuggestUpdateIfNewer ( VersionUtils.Current );
					//-----------------------------------------------------------------------------------------------------------
					}, AppInfos.Guid );
				//---------------------------------------------------------------------------------------------------------------
				}
		...
		private void WebBrowser_ScriptNotify ( object Sender, NotifyEventArgs Args )
			...
			if ( QueryString.ContainsKey ( "Method" ) )
				...
				switch ( QueryString["Method"] )
					...
					//-----------------------------------------------------------------------------------------------------------
					#region // Réponse à la Question du Jour
					//-----------------------------------------------------------------------------------------------------------
//					case "AnswerPoll" :
//						{
						//-------------------------------------------------------------------------------------------------------
...
//						string QuestionID = QueryString["QuestionID"];
//						string Value      = QueryString["Value"     ];

//						RestService.AnswerPoll ( QuestionID, Value, (S, A) =>
//							{
							//---------------------------------------------------------------------------------------------------
//							StorageSettings.SetValue ( "question-id", QuestionID );
