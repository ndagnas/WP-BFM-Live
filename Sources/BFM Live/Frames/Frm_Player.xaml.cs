	...
	public partial class Frm_Player : PhoneApplicationPage
		...
		private MediaPlayer GetPlayer ( bool AutoClose )
			...
			if ( this.LiveMediaControl == null )
				...
				this.LiveMediaControl.MediaQuality                = Microsoft.PlayerFramework.MediaQuality.HighDefinition;
							...
							using ( StringReader Sr = new StringReader ( A.Content ) )
								...
								while ( ( Line = Sr.ReadLine () ) != null )
									...
									if ( Line.StartsWith ( "#EXT-X-STREAM-INF" ) )
										...
										BandWidth = Line.Substring ( P1 + 10, P2 - P1 - 10 ).
										                                          ToInteger ( -1 );
										
										if ( Buffer.Contains ( BandWidth ) ) BandWidth = -1;

										Buffer.Add ( BandWidth );
										}
									else if ( Line.StartsWith ( "http:" ) && BandWidth != -1 )
										{
										LiveStreams.Add ( new LiveStream ( BandWidth, 
										                                      new Uri ( Line ) ) );
										}
