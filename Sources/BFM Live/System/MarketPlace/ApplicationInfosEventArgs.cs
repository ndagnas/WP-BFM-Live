	...
	public class ApplicationInfosEventArgs : EventArgs
		...
		internal ApplicationInfosEventArgs ( XElement StoreContent, CultureInfo CultureInfo )
			...
			try
				...
				// Ads
				//---------------------------------------------------------------------------------------------------------------
				var XAds = StoreContent.Element ( "ads" );

				if ( XAds != null ) this.Ads = XAds.Value;
				//---------------------------------------------------------------------------------------------------------------
				
				//---------------------------------------------------------------------------------------------------------------
				// AverageUserRating
				//---------------------------------------------------------------------------------------------------------------
				var XAverageUserRating = StoreContent.Element ( "averageUserRating" );

				if ( XAverageUserRating != null )
					this.AverageUserRating = XAverageUserRating.Value.ToFloat ();
				//---------------------------------------------------------------------------------------------------------------

				//---------------------------------------------------------------------------------------------------------------
				// Description
				//---------------------------------------------------------------------------------------------------------------
				var XDescription = StoreContent.Element ( "content" );
				...
				// Guid
				//---------------------------------------------------------------------------------------------------------------
				var XGuid = StoreContent.Element ( "id" );
				...
				// Publisher
				//---------------------------------------------------------------------------------------------------------------
				var XPublisher = StoreContent.Element ( "publisher" );
				...
				// FirstPublished
				//---------------------------------------------------------------------------------------------------------------
				var XFirstPublished = StoreContent.Element ( "releaseDate" );
				...
				// IsPublished
				//---------------------------------------------------------------------------------------------------------------
				var XIsPublished = StoreContent.Element ( "visibilityStatus" );
				...
				// Title
				//---------------------------------------------------------------------------------------------------------------
				var XTitle = StoreContent.Element ( "title" );
				...
				// UserRatingCount
				//---------------------------------------------------------------------------------------------------------------
				var XUserRatingCount = StoreContent.Element ( "userRatingCount" );
				...
				//---------------------------------------------------------------------------------------------------------------
				var XEntry = StoreContent.Element ( "entry" );
				...
				if ( XEntry != null )
					...
					// LastPublished
					//-----------------------------------------------------------------------------------------------------------
					var XLastPublished = XEntry.Element ( "skuLastUpdated" );
					...
					// Conditions ...
					//-----------------------------------------------------------------------------------------------------------
					var XIsAvailableInCountry   = XEntry.Element ( "isAvailableInCountry"   );
					var XIsAvailableInStore     = XEntry.Element ( "isAvailableInStore"     );
					var XIsBlacklisted          = XEntry.Element ( "isBlacklisted"          );
					var XIsClientTypeCompatible = XEntry.Element ( "isClientTypeCompatible" );
					var XIsHardwareCompatible   = XEntry.Element ( "isHardwareCompatible"   );
					...
					// Version
					//-----------------------------------------------------------------------------------------------------------
					var XVersion = XEntry.Element ( "version" );
		...
		public void SuggestUpdateIfNewer ( Version Current )
			...
			if ( IndexVersion != -1 )
				...
				try
					...
					Inner.Children.Add ( new Border () { Opacity = 0.1, Background = Foreground } );
		...
		//***********************************************************************************************************************
		/// <summary>
		/// Obtiens l'identifiant publicitaire de l'application.
		/// </summary>
		//-----------------------------------------------------------------------------------------------------------------------
